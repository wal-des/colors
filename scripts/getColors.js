            ...
            for (var i = 0; i < allRecords.length; i++) {
                ...
                document.querySelector("#color-list").innerHTML += `
                      <li class="color-item">
                        ...
                        <div class="modal">
                            <div class="modal-container" id="colorDetails-${allRecords[i].id}">
                            <div class="card-text">
                                <div class="card-header-row">
                                <h1 class="color-name">${allRecords[i].colorName || ''}</h1>
                                <p class="color-number">${allRecords[i].colorCode || ''}</p>
                                </div>
                                <div class="card-text-row">
                                <p class="make-name">${allRecords[i].brand || ''}</p>
                            ...
                            <div class="modal-content">
                                <img src=${allRecords[i].swatchImage || ''} alt=""
                                class="color-image-modal"
                                onerror="this.src='../images-default/no-color-pigment.svg';">
                                ...
                                <div class="details-section">
                                    <h2>Pigments</h2>
                                    <div class="card-text-row">
                                    <p class="color-information-tag">${allRecords[i].pigments || 'No pigment information.'}</p>
                                    </div>
                                </div>
                            </div>
